...
#' \item{scheme_id}{Numeric. An ID number that uniquely identifies each
#' classification scheme. Coded \code{1} for the pre-Lisbon version of
#' EUR-Lex's Case Law Directory, coded \code{2} for the post-Lisbon version of
#' EUR-Lex's Case Law Directory, and coded \code{3} for EUR-Lex's Directory of
#' Legal Acts. See the variable \code{scheme}.}
#' \item{scheme}{String. The classification scheme. Possible values include:
#' \code{Pre-Lisbon version of EUR-Lex's Case Law Directory},
#' \code{Post-Lisbon version of EUR-Lex's Case Law Directory}, and
#' \code{EUR-Lex's Directory of Legal Acts}.}
